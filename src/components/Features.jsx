...
const Features = () => {
    useGSAP(() => {
        ...
        animateWithGsap('.g_grow', { scale: 1, opacity: 1, ease: 'power' }, { scrub: 5.5 });
                            ...
                            <div className="feature-text-container">
                                <div className="flex-1 flex-center">
                                    <p className="feature-text g_text">iPhone 15 Pro is {' '}
                                        ...
                                        using the same alloy that spacecrafts use for a mission to Mars. The result is a device that’s stronger, lighter, and more sustainable than ever before.
                                    </p>
                                </div>

                                <div className="flex-1 flex-center">
                                    <p className="feature-text g_text">Titanium has one of the best strength-to-weight ratios of any metal, making these our {' '}
                                        <span className="text-white">the lightest Pro models ever.
                                        </span>
